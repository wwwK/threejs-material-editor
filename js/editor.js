...
var MaterialEditor = function (editor) {
  ...
  function autoCameraDistance(object) {
    ...
    editor.threeCore.camera.far = editor.threeCore.cameraController.maxDistance + 1000;
  ...
  self.functionOptions = {
    ...
    export: function (options) {
      ...
      function save_drcobj(jsonData) {
        var save_buffer = (new THREE.DrcobjExporter()).parse(jsonData, { quantization: [24, 8, 24, 8, 8] });
